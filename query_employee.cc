...
// Iterates though all employees in the StaffBook and print specified Employee info based on ID which user input.
void QueryEmployee(const staffbook::StaffBook& staff_book) {
...
// Main function:  Reads the entire staff book from a file and
//   print specified Employee info based on ID which user input.
